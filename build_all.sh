...
docker build -f py38-alpine-compile-flags.Dockerfile -t sizetest_py38-alpine-compile-flags .
docker build -f py38-alpine-compile-unoptimized.Dockerfile -t sizetest_py38-alpine-compile-unoptimized .
...
docker build -f py38-slim-cache-clear-unsuccesfull.Dockerfile -t sizetest_py38-slim-cache-clear-unsuccesfull .
